...
public class BpmNotificationsController implements IOsgiWebController {
	...
	public GenericResultBean getTemplates(final OsgiWebRequest invocation) {
        ...
        Collections.sort(bpmNotificationTemplatesList, new Comparator<BpmNotificationTemplate>() {
            @Override
            public int compare(BpmNotificationTemplate o1, BpmNotificationTemplate o2) {
