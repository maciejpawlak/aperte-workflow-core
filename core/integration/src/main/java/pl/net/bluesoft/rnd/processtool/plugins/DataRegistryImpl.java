...
public class DataRegistryImpl implements DataRegistry {
	...
	private final Map<String, AuditLogHandler> auditLogHandlers = new HashMap<String, AuditLogHandler>();
	...
	public void addAuditLogHandler(AuditLogHandler handler) {
		auditLogHandlers.put(handler.getName(), handler);
	}

	@Override
	public void removeAuditLogHandler(AuditLogHandler handler) {
		auditLogHandlers.remove(handler.getName());
	}

	@Override
	public Collection<AuditLogHandler> getAuditLogHandlers() {
		return Collections.unmodifiableCollection(auditLogHandlers.values());
	}
